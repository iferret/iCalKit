...
extension Property.Kind {
    ...
    /// ICAL_NO_PROPERTY
    public static var NO: Property.Kind { .init(rawValue: ICAL_NO_PROPERTY) }
    
    /// [Property.Kind]
    public static var allCases: [Property.Kind] {
        return [ANY, ACCEPTRESPONSE, ACKNOWLEDGED, ACTION, ALLOWCONFLICT, ATTACH, ATTENDEE, BUSYTYPE, CALID, CALMASTER, CALSCALE, CAPVERSION, CARLEVEL, CARID, CATEGORIES, CLASS, CMD, COLOR, COMMENT, COMPLETED, COMPONENTS, CONFERENCE, CONTACT, CREATED, CSID, DATEMAX, DATEMIN, DECREED, DEFAULTCHARSET, DEFAULTLOCALE, DEFAULTTZID, DEFAULTVCARS, DENY, DESCRIPTION, DTEND, DTSTAMP, DTSTART, DUE, DURATION, ESTIMATEDDURATION, EXDATE, EXPAND, EXRULE, FREEBUSY, GEO, GRANT, IMAGE, ITIPVERSION, LASTMODIFIED, LOCATION, MAXCOMPONENTSIZE, MAXDATE, MAXRESULTS, MAXRESULTSSIZE, METHOD, MINDATE, MULTIPART, NAME, ORGANIZER, OWNER, PATCHDELETE, PATCHORDER, PATCHPARAMETER, PATCHTARGET, PATCHVERSION, PERCENTCOMPLETE, PERMISSION, POLLCOMPLETION, POLLITEMID, POLLMODE, POLLPROPERTIES, POLLWINNER, PRIORITY, PRODID, QUERY, QUERYLEVEL, QUERYID, QUERYNAME, RDATE, RECURACCEPTED, RECUREXPAND, RECURLIMIT, RECURRENCEID, REFRESHINTERVAL, RELATEDTO, RELCALID, REPEAT, REPLYURL, REQUESTSTATUS, RESOURCES, RESPONSE, RESTRICTION, RRULE, SCOPE, SEQUENCE, SOURCE, STATUS, STORESEXPANDED, SUMMARY, TARGET, TASKMODE, TRANSP, TRIGGER, TZID, TZIDALIASOF, TZNAME, TZOFFSETFROM, TZOFFSETTO, TZUNTIL, TZURL, UID, URL, VERSION, VOTER, X, XLICCLASS, XLICCLUSTERCOUNT, XLICERROR, XLICMIMECHARSET, XLICMIMECID, XLICMIMECONTENTTYPE, XLICMIMEENCODING, XLICMIMEFILENAME, XLICMIMEOPTINFO, NO]
    }
}
...
extension Property.Action {
    ...
    /// [Property.Action]
    public static var allCases: [Property.Action] {
...
extension Property.BusyType {
    ...
    /// [Property.BusyType]
    public static var allCases: [Property.BusyType] {
...
extension Property.CarLevel {
    ...
    /// [Property.CarLevel]
    public static var allCases: [Property.CarLevel] {
...
extension Property.Class {
    ...
    /// [Property.Class]
    public static var allCases: [Property.Class] {
...
extension Property.Command {
    ...
    /// [Property.Command]
    public static var allCases: [Property.Command] {
...
extension Property.Method {
    ...
    /// [Property.Method]
    public static var allCases: [Property.Method] {
...
extension Property.PollCompletion {
    ...
    public static var allCases: [Property.PollCompletion] {
...
extension Property.PollMode {
    ...
    /// [Property.PollMode]
    public static var allCases: [Property.PollMode] {
        return [X, BASIC, NONE]
    }
...
extension Property.QueryLevel {
    ...
    /// [Property.QueryLevel]
    public static var allCases: [Property.QueryLevel] {
...
extension Property.Status {
    ...
    /// [Property.Status]
    public static var allCases: [Property.Status] {
...
extension Property.TaskMode {
    ...
    /// [Property.TaskMode]
    public static var allCases: [Property.TaskMode] {
...
extension Property.Transp {
    ...
    /// [Property.Transp]
    public static var allCases: [Property.Transp] {
...
extension Property.XlicClass {
    ...
    /// [Property.XlicClass]
    public static var allCases: [Property.XlicClass] {
        return [X, PUBLISHNEW, PUBLISHUPDATE, PUBLISHFREEBUSY, REQUESTNEW, REQUESTUPDATE, REQUESTRESCHEDULE, REQUESTDELEGATE, REQUESTNEWORGANIZER, REQUESTFORWARD, REQUESTSTATUS, REQUESTFREEBUSY, REPLYACCEPT, REPLYDECLINE, REPLYDELEGATE, REPLYCRASHERACCEPT, REPLYCRASHERDECLINE, ADDINSTANCE, CANCELEVENT, CANCELINSTANCE, CANCELALL, REFRESH, COUNTER, DECLINECOUNTER, MALFORMED, OBSOLETE, MISSEQUENCED, UNKNOWN, NONE]
    }
